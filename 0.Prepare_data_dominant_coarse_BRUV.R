...
# save
writeOGR(sp1, dsn= s.dir, layer= "GB_Bruvs_coarse_bathy_habitat_dominant_broad", driver="ESRI Shapefile", overwrite_layer=TRUE)
write.csv(Bruv_dom, paste(d.dir, "tidy", "GB_Bruvs_coarse_bathy_habitat_dominant_broad.csv", sep='/'))
